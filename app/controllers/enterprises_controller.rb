class EnterprisesController < ApplicationController
  ...
  def edit_profile
    @current_user.enterprise.update_attributes(enterprise_params.reject { |_, v| v.blank? }) if request.post?
  end
  ...
  def validate
    ...
    redirect_to adviser_dashboard_path and return false unless @current_user.is_enterprise?
  end
end
